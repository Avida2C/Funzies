    ...
    <div class="row">
        <div class="col">
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to
                the information that they shared and/or collect in Funzies Collection. This policy is not applicable to
                any
            ...
            <p>Funzies Collection follows a standard procedure of using log files. These files log visitors when they
                visit
                websites. All hosting companies do this and a part of hosting services' analytics. The information
                collected by log
                files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and
                time stamp,
            ...
            <p>Like any other website, Funzies Collection uses "cookies". These cookies are used to store information
                including
            ...
            <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Funzies
                Collection.</p>

            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in
                their respective advertisements and links that appear on Funzies Collection, which are sent directly to
                users'
            ...
            <p>Note that Funzies Collection has no access to or control over these cookies that are used by third-party
                advertisers.
            </p>

            <h3><strong>Third Party Privacy Policies</strong></h3>

            <p>Funzies Collection's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                advising you to
            ...
            <p>Funzies Collection does not knowingly collect any Personal Identifiable Information from children under
                the age of
