...
<div class="container py-4 col-sm-12 col-md-12 col-lg-8 col-xl-8">
    <div class="row">
        <div class="col">
            ...
            <p>Welcome to Funzies Collection!</p>

            <p>These terms and conditions outline the rules and regulations for the use of Funzies's Website, located at
                Funzies.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Funzies
                Collection if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
                ...
                prevailing law of mt. Any use of the above terminology or other words in the singular, plural,
                capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to same.
            </p>

            <h3><strong>Cookies</strong></h3>

            <p>We employ the use of cookies. By accessing Funzies Collection, you agreed to use cookies in agreement
                with the Funzies's Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, Funzies and/or its licensors own the intellectual property rights for all
                material on Funzies Collection. All intellectual property rights are reserved. You may access this from
                Funzies Collection for your own personal use subjected to restrictions set in these terms and
                conditions.</p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Funzies Collection</li>
                <li>Sell, rent or sub-license material from Funzies Collection</li>
                <li>Reproduce, duplicate or copy material from Funzies Collection</li>
                <li>Redistribute content from Funzies Collection</li>
            </ul>
            ...
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. Funzies does not filter, edit, publish or review Comments prior to their
                presence on the website. Comments do not reflect the views and opinions of Funzies,its agents and/or
                affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To
                the extent permitted by applicable laws, Funzies shall not be liable for the Comments or for any
            ...
            <p>Funzies reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            <p>You hereby grant Funzies a non-exclusive license to use, reproduce, edit and authorize others to use,
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                absence of Funzies; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to Funzies. Please include your name, your organization
            ...
            <p>No use of Funzies's logo or other artwork will be allowed for linking absent a trademark license
                agreement.</p>
