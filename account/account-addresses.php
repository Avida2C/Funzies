...
<div class="mt-4">
    ...
    <button type="button" class="btn btn-success mt-2 rounded-0" data-bs-toggle="modal" data-bs-target="#addAddressModal">Add New Address</button>
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            ...
                            <input class="w-100 p-1" type="text" id="firstname" name="firstname" required autocomplete="firstname">
                        </div>
                        <div class="mb-4">
