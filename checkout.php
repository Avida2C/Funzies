    ...
    <div class="row justify-content-center">
        ...
        <div id="loginMessage" class="col-sm-12 col-md-12 col-lg-5 col-xl-5 mx-4">
            ...
            <form id="customerDetailsForm" class="form" method="POST" name="customerDetailsForm">
                ...
                <input type="hidden" name="newAddressSelected" value="<?php echo $selectedAddress == null ? 'true' : 'false' ?>">
                ...
                <?php if($user != null) : ?>
                    ...
                    <input class="w-100 p-1 mb-3" type="text" id="userfirstname-input" name="userfirstname" value="<?php echo $user["Name"]?>" required disabled>

                    <label for="lastname-input">Last Name:<span class="text-danger">*</span></label>
                    <input class="w-100 p-1 mb-3" type="text" id="userlastname-input" name="userlastname" value="<?php echo $user["Surname"]?>" required disabled>

                    <label for="email-input">E-Mail:<span class="text-danger">*</span></label>
                    <input class="w-100 p-1 mb-3" type="tel" id="email-input" name="email" value="<?php echo $user["Email"]?>" required disabled autocomplete="email">

                    <label for="phone-input">Mobile Number:<span class="text-danger">*</span></label>
                    <input class="w-100 p-1 mb-3" type="tel" id="user-phone-input" name="userphone" value="<?php echo $user["ContactNumber"]?>" required disabled autocomplete="tel">
                <?php else : ?>
                    <label for="firstname-input">First Name:<span class="text-danger">*</span></label>
                    ...
                    <label for="phone-input">Mobile Number:<span class="text-danger">*</span></label>
                    <input class="w-100 p-1 mb-3" type="tel" id="user-phone-input" name="userphone" required autocomplete="tel">
                    ...
                    <input class="w-100 p-1 mb-3" type="password" id="password-input" name="password" required autocomplete="email">
                <?php endif; ?> 

                <h3 class="product-card-font fs-4 my-3">Delivery Details</h3>
                <?php if($selectedAddress != null) : ?>
                    <label for="firstname-input">First Name:<span class="text-danger">*</span></label>
                    <input class="w-100 p-1 mb-3" type="text" id="firstname-input" name="firstname" value="<?php echo $selectedAddress["Name"]?>" required disabled>

                    <label for="lastname-input">Last Name:<span class="text-danger">*</span></label>
                    <input class="w-100 p-1 mb-3" type="text" id="lastname-input" name="lastname" value="<?php echo $selectedAddress["Surname"]?>" required disabled>
            ...
            <div class="container overflow-auto" style="height:350px;">
                ...
                <table class="table">
                    ...
                    <tr class="align-middle">
                        ...
                        <td>
                            <p class="product-card-font fs-5 text-danger">&euro;<?php echo number_format(((float)$item['Price'] * (float)$item['Quantity']), 2, '.', '');?></p>
                        </td>
                    </tr>
                    <?php } ?>
