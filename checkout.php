...
<!-- Page Title -->
<div class="container col-sm-12 col-md-12 col-lg-10 col-xl-10 div-spacing-mt mb-4">
    <h3 class="fs-3 text-center">Check Out</h3>
</div>

<div class="container col-sm-12 col-md-12 col-lg-10 col-xl-10 div-spacing-mb">
    <div class="row justify-content-center">
        ...
        <p class="product-card-font bg-danger p-2 fs-6 text-white w-100 mb-4">Already have an account? <a
            ...
            <form class="form" method="GET">
                ...
                <select class="form rounded-0 p-1 mb-3" style="width: 100%;">
